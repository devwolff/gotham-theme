;;; doom-bludhaven-theme.el --- inspired by Oceanic Next -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

(defgroup doom-bludhaven-theme nil
  "Options for the `doom-bludhaven' theme."
  :group 'doom-themes)

(defcustom doom-bludhaven-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-bludhaven-theme
  :type 'boolean)

(defcustom doom-bludhaven-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-bludhaven-theme
  :type 'boolean)

(defcustom doom-bludhaven-comment-bg doom-bludhaven-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-bludhaven-theme
  :type 'boolean)

(defcustom doom-bludhaven-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-bludhaven
  ...
  ((bg         '("#1B2B34" nil       nil            ))
   ...
   (highlight      cyan)
   (vertical-bar   (doom-darken base1 0.6))
   (selection      base1)
   (builtin        red)
   (comments       (if doom-bludhaven-brighter-comments dark-cyan base3))
   (doc-comments   (doom-lighten (if doom-bludhaven-brighter-comments dark-cyan base3) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       violet)
   (methods        blue)
   ...
   (-modeline-bright doom-bludhaven-brighter-modeline)
   (-modeline-pad
    (when doom-bludhaven-padded-modeline
      (if (integerp doom-bludhaven-padded-modeline) doom-bludhaven-padded-modeline 4)))
  ...
  (
   ...
   ((font-lock-comment-face &override)
    :background (if doom-bludhaven-comment-bg (doom-lighten bg 0.05)))
...
;;; doom-bludhaven-theme.el ends here
