;;; TODO: bludhaven-theme.el --- A very dark Emacs color theme
...
;; A port of the Bludhaven theme for Vim to Emacs 24 that uses the new
;; theming support.
...
(deftheme gotham "The Bludhaven color theme")
